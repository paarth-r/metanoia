/* Metanoia todo core, mobile copy. The SHARED region below is byte-identical
   to todos-core.js at the repo root; test/todos-core.test.js fails if they
   drift. Edit both, or neither. */
...
export {
  isoOf, isoTodayLocal, parseIsoLocal, shiftIso, todoAppearsOn,
  resolveTodosForDate, todoCountsForDate, monthGrid, monthLabel, planDayOf,
  endDateForStop, dayHasMark,
